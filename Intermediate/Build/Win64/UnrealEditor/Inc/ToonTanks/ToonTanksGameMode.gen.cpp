...
// End Cross Module References
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AToonTanksGameMode_Statics::NewProp_startDelay_MetaData[] = {
		{ "Category", "ToonTanksGameMode" },
		{ "ModuleRelativePath", "ToonTanksGameMode.h" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AToonTanksGameMode_Statics::NewProp_startDelay = { "startDelay", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AToonTanksGameMode, startDelay), METADATA_PARAMS(Z_Construct_UClass_AToonTanksGameMode_Statics::NewProp_startDelay_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AToonTanksGameMode_Statics::NewProp_startDelay_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AToonTanksGameMode_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AToonTanksGameMode_Statics::NewProp_startDelay,
	};
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AToonTanksGameMode_Statics::ClassParams = {
		...
		DependentSingletons,
		FuncInfo,
		Z_Construct_UClass_AToonTanksGameMode_Statics::PropPointers,
		nullptr,
		UE_ARRAY_COUNT(DependentSingletons),
		UE_ARRAY_COUNT(FuncInfo),
		UE_ARRAY_COUNT(Z_Construct_UClass_AToonTanksGameMode_Statics::PropPointers),
		0,
		0x009002ACu,
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ToonTanks_Source_ToonTanks_ToonTanksGameMode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AToonTanksGameMode, AToonTanksGameMode::StaticClass, TEXT("AToonTanksGameMode"), &Z_Registration_Info_UClass_AToonTanksGameMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AToonTanksGameMode), 870445869U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ToonTanks_Source_ToonTanks_ToonTanksGameMode_h_4076669192(TEXT("/Script/ToonTanks"),
